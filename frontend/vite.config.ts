  ...
  build: {
    ...
    rollupOptions: {
      ...
      input: {
        ...
        landing: "src/entrypoints/Landing.entry.tsx",
        profile: "src/entrypoints/Profile.entry.tsx",
        topic_list: "src/entrypoints/TopicList.entry.tsx",
        topic_questions: "src/entrypoints/TopicQuestions.entry.tsx",
      },
    },
  },
  server: {
