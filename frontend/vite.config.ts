  ...
  build: {
    ...
    rollupOptions: {
      ...
      input: {
        ...
        react_edit_question: "src/entrypoints/EditQuestion.tsx",
        react_edit_question_inline: "src/entrypoints/InlineQuestionEditor.tsx",
        audio_quiz_entry: "src/audio/audio_quiz_entry.tsx",
        quiz_markdown: "src/QuizMarkdown.tsx",
        ai_question_generator: "src/entrypoints/AiQuestionGenerator.tsx",
      },
    },
  },
  server: {
